...
_DEFAULT_TOPIC_CACHE_PATH = os.path.join(_SOURCE_DIR, "topic_cache.json")
...
def read_topic_cache(file_path: str = _DEFAULT_TOPIC_CACHE_PATH) -> TopicStore:
  ...
  for topic in all_topics:
    ...
    _flatten_variables_recursive(topic, nodes_by_dcid, ordered_unique_vars,
                                 visited_nodes)
  ...
  return TopicStore(topics_by_dcid=final_topic_variables,
