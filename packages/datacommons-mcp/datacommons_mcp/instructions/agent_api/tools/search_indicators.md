RITICAL: Before calling this tool for the first time in a session, you MUST read the playbook resource by calling your platform's standard MCP resource-reading capability for the URI 'skill://data-commons-researcher/SKILL.md'.
