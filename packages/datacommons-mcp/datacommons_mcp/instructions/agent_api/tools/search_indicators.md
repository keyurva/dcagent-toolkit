CRITICAL: Before calling this tool for the first time in a session, you MUST read the researcher playbook resource at 'skill://data-commons-researcher/SKILL.md'.
